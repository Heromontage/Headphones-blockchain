              ...
              <div className="p-8 overflow-y-auto">
                {step === 'wallet' ? (
                  <div className="flex flex-col items-center justify-center py-8 text-center space-y-6">
                    <div className="w-16 h-16 bg-[#c87941]/20 rounded-full flex items-center justify-center mb-2">
                      <span className="text-3xl">🦊</span>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Connect Your Wallet</h3>
                      <p className="text-sm text-white/50 mb-6">
                        You need to connect MetaMask to place orders and earn AETHER points.
                      </p>
                    </div>
                    ...
                    <button
                      ...
                      className="text-xs text-white/40 hover:text-white/80 underline mt-4"
                    >
                      Skip for now (Ordering will be disabled)
                    </button>
                    {isConnected && address && (
                      <p className="text-[#c87941] text-sm mt-4 animate-pulse">
